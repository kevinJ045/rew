rew.prototype.mod.prototype.defineNew("/home/makano/workspace/rew-rust/test/types.coffee", {
"/home/makano/workspace/rew-rust/test/types.coffee"(globalThis){
with (globalThis) {
...
let _not_person = struct({
  kk: str
})

let sample = _person.prototype.new({name: 'ss', age: 4})

match(sample)
  .on(_not_person, function() { return print('Matched person:', sample.name, sample.age) })
  .default(function() { return print('nope') })
  .end
...
let person = instantiate(class {
  name = rew.prototype.types.prototype.str( input('Name: '))
  age = rew.prototype.types.prototype.int( input('Age: '))
})

print(person.name, 'is', person.age, 'years old.')

match(person.name)
  .on('Makano', function() { return print('Hello, Makano!') })
  .on(/jo/i, function() { return print('Hello, John!') })
  .default(function() { return print('Hello, stranger!') })  
  .end

}
return globalThis.module.exports;
}          
}, ["app://test.app/types"]);(function(module){
"no-compile"
...
rew.prototype.mod.prototype.get('/home/makano/workspace/rew-rust/test/types.coffee');