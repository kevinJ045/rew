...
const { ArrayPrototypeIncludes, ArrayPrototypeMap, ArrayPrototypePush, StringPrototypeCharCodeAt, StringPrototypeSplit, StringPrototypeToLowerCase, StringPrototypeToUpperCase, TypeError, Symbol, } = primordials;
...
import { _idleTimeoutDuration, _idleTimeoutTimeout, _server, createWebSocketBranded, WebSocket, } from "ext:deno_websocket/01_websocket.js";
...
function upgradeWebSocket(request, options = { __proto__: null }) {
    ...
    socket[_idleTimeoutDuration] = (_a = options.idleTimeout) !== null && _a !== void 0 ? _a : 30;
