...
module.exports.prepareContext = function(custom_context, options, filepath = '', runPath = () => {}){
  let context = {
    module: {
      exports: null,
      options,
  ...
  if(options.useContext) {
    ...
    context = {
      ...context,
      ...defaultContext,
      require: (package) => { try { return require(package) } catch(e) { throw new Error('Module not found') } },
      ...custom_context
    }
