...
module.exports.imp = function (runPath, context) {
	return function (filename, options = {}) {
		...
		if (ispkg) {
			...
			exports = runPath(path.resolve(path.dirname(context.module.filepath), filename), { ...options, useContext: true }, context).context
				.module.exports;
		} else if (type == 'js') {
			exports = runPath(
			...
			const pathname = path.resolve(path.dirname(context.module.filepath), filename);
