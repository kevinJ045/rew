...
(function () {
	...
	exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
		constructor(originalValue, { quote, initialChunk, finalChunk, indent: indent1, double: double1, heregex: heregex1 } = {}) {
		...
		withoutQuotesInLocationData() {
			...
			if (endsWithNewline) {
				...
				locationData.last_column =
					locationData.last_line === locationData.first_line
						? locationData.first_column + this.originalValue.length - '\n'.length
						: this.originalValue.slice(0, -1).length - '\n'.length - this.originalValue.slice(0, -1).lastIndexOf('\n');
			} else {
	...
	exports.Value = Value = function () {
		class Value extends Base {
			constructor(base, props, tag, isDefaultValue = false) {
				...
				// to be on `foo`.
				if (
					((ref1 = this.base) != null ? ref1.comments : void 0) &&
					this.base instanceof ThisLiteral &&
					((ref2 = this.properties[0]) != null ? ref2.name : void 0) != null
				) {
			...
			looksStatic(className) {
				...
				if (
					!(
						((thisLiteral = this.base) instanceof ThisLiteral || (name = this.base).value === className) &&
						this.properties.length === 1 &&
						((ref1 = this.properties[0].name) != null ? ref1.value : void 0) !== 'prototype'
					)
				) {
					return false;
				}
			...
			object() {
				...
				object.locationData =
					initialProperties.length === 0
						? this.base.locationData
						: mergeLocationData(this.base.locationData, initialProperties[initialProperties.length - 1].locationData);
				return object;
			}
			...
			astLocationData() {
				...
				return mergeAstLocationData(
					jisonLocationDataToAstLocationData(this.base.tagNameLocationData),
					jisonLocationDataToAstLocationData(this.properties[this.properties.length - 1].locationData),
				);
			}
		}
	...
	exports.HereComment = HereComment = class HereComment extends Base {
		constructor({ content: content1, newLine, unshift, locationData: locationData1 }) {
			super();
	...
	exports.LineComment = LineComment = class LineComment extends Base {
		constructor({ content: content1, newLine, unshift, locationData: locationData1, precededByBlankLine }) {
			super();
			this.content = content1;
			this.newLine = newLine;
			this.unshift = unshift;
		...
		class JSXAttribute extends Base {
			constructor({ name: name1, value }) {
				...
				this.value =
					value != null
						? ((value = value.base),
							value instanceof StringLiteral && !value.shouldGenerateTemplateLiteral() ? value : new JSXExpressionContainer(value))
						: null;
	...
	exports.JSXAttributes = JSXAttributes = function () {
		class JSXAttributes extends Base {
			...
			checkValidAttribute(object) {
				...
				if (
					!(attribute instanceof Obj || attribute instanceof IdentifierLiteral) ||
					(attribute instanceof Obj && !attribute.generated && (properties.length > 1 || !(properties[0] instanceof Splat)))
				) {
	...
	exports.JSXElement = JSXElement = function () {
		class JSXElement extends Base {
			constructor({ tagName: tagName1, attributes, content: content1 }) {
				super();
			...
			astNode(o) {
				...
				if (this.content != null) {
					this.closingElementLocationData = mergeAstLocationData(
						...
						for (j = 0, len1 = ref1.length; j < len1; j++) {
							...
							if (element instanceof StringLiteral) {
								...
								if (expression == null) {
									...
									results1.push(
										new JSXExpressionContainer(emptyExpression, {
									...
									if (unwrapped instanceof JSXElement && unwrapped.locationData.range[0] === element.locationData.range[0]) {
										...
										results1.push(
											new JSXExpressionContainer(unwrapped, {
												locationData: element.locationData,
											}),
										);
									}
		...
		class Super extends Base {
			...
			astNode(o) {
				...
				if (this.accessor != null) {
					return new Value(new Super().withLocationDataFrom((ref1 = this.superLiteral) != null ? ref1 : this), [this.accessor])
						.withLocationDataFrom(this)
						.ast(o);
				}
				return super.astNode(o);
	...
	exports.Access = Access = function () {
		class Access extends Base {
			constructor(name1, { soak: soak1, shorthand } = {}) {
				super();
				this.name = name1;
				this.soak = soak1;
	...
	exports.Range = Range = function () {
		class Range extends Base {
			...
			compileNode(o) {
				...
				condPart =
					this.step != null
						? this.stepNum != null && this.stepNum !== 0
							? this.stepNum > 0
								? `${lowerBound}`
								: `${upperBound}`
						...
						: known
							? `${from <= to ? lt : gt} ${to}`
							: `(${this.fromVar} <= ${this.toVar} ? ${lowerBound} : ${upperBound})`;
					...
					if (!(!this.range.exclusive && +compiledText === -1)) {
						toStr =
							...
							(this.range.exclusive
								...
								: to.isNumber()
									? `${+compiledText + 1}`
									: ((compiled = to.compileToFragments(o, LEVEL_ACCESS)), `+${fragmentsToText(compiled)} + 1 || 9e9`));
					}
				}
		...
		class Obj extends Base {
			...
			compileNode(o) {
				...
				for (i = l = 0, len3 = props.length; l < len3; i = ++l) {
					...
					key =
						prop instanceof Assign && prop.context === 'object'
							? prop.variable
							: prop instanceof Assign
								? (!this.lhs ? prop.operatorToken.error(`unexpected ${prop.operatorToken.value}`) : void 0, prop.variable)
								: prop;
					...
					if (key === prop) {
						if (prop.shouldCache()) {
							...
							!(typeof prop.bareLiteral === 'function' ? prop.bareLiteral(IdentifierLiteral) : void 0) &&
			...
			expandProperty(property) {
				...
				key =
					property instanceof Assign && context === 'object'
						? variable
						: property instanceof Assign
							? (!this.lhs ? operatorToken.error(`unexpected ${operatorToken.value}`) : void 0, variable)
							: property;
				if (key instanceof Value && key.hasProperties()) {
	...
	exports.ObjectProperty = ObjectProperty = class ObjectProperty extends Base {
		constructor({ key, fromAssign }) {
			...
			super();
			if (fromAssign) {
				({ variable: this.key, value, context } = fromAssign);
				if (context === 'object') {
		...
		astProperties(o) {
			...
			isComputedPropertyName =
				(this.key instanceof Value && this.key.base instanceof ComputedPropertyName) ||
				this.key.unwrap() instanceof StringWithInterpolations;
			keyAst = this.key.ast(o, LEVEL_LIST);
			return {
				key: (keyAst != null ? keyAst.declaration : void 0)
					? Object.assign({}, keyAst, {
							declaration: false,
						})
					: keyAst,
		...
		class Arr extends Base {
			...
			compileNode(o) {
				...
				for (objIndex = j = 0, len1 = ref1.length; j < len1; objIndex = ++j) {
					...
					if (
						unwrappedObj.comments &&
						unwrappedObj.comments.filter(function (comment) {
							return !comment.here;
						}).length === 0
					) {
				...
				if (includesLineCommentsOnNonFirstElement || indexOf.call(fragmentsToText(answer), '\n') >= 0) {
					for (fragmentIndex = p = 0, len4 = answer.length; p < len4; fragmentIndex = ++p) {
						...
						if (fragment.isHereComment) {
							...
							fragment.code === ', ' &&
							!(fragment != null ? fragment.isElision : void 0) &&
							(ref2 = fragment.type) !== 'StringLiteral' &&
							ref2 !== 'StringWithInterpolations'
						) {
							fragment.code = `,\n${o.indent}`;
						}
					}
		...
		class Class extends Base {
			...
			addInitializerMethod(assign) {
				...
				if (method.isStatic) {
					...
					isConstructor =
						methodName instanceof StringLiteral ? methodName.originalValue === 'constructor' : methodName.value === 'constructor';
					if (isConstructor) {
	...
	exports.ExecutableClassBody = ExecutableClassBody = function () {
		class ExecutableClassBody extends Base {
			...
			compileNode(o) {
				...
				if (this.externalCtor) {
					externalCtor = new IdentifierLiteral(
						o.classScope.freeVariable('ctor', {
							reserve: false,
						}),
					);
	...
	exports.ClassProperty = ClassProperty = function () {
		class ClassProperty extends Base {
			constructor({ name: name1, isStatic, staticClassName: staticClassName1, value: value1, operatorToken: operatorToken1 }) {
				super();
				this.name = name1;
	...
	exports.ClassPrototypeProperty = ClassPrototypeProperty = function () {
		class ClassPrototypeProperty extends Base {
			constructor({ name: name1, value: value1 }) {
				super();
				this.name = name1;
				this.value = value1;
			}
	...
	exports.ImportClause = ImportClause = function () {
		class ImportClause extends Base {
			...
			astNode(o) {
				...
				return compact(
					flatten([(ref1 = this.defaultBinding) != null ? ref1.ast(o) : void 0, (ref2 = this.namedImports) != null ? ref2.ast(o) : void 0]),
				);
			}
		}
		...
		class Assign extends Base {
			...
			isStatement(o) {
				return (
					...
					this.context != null &&
					(this.moduleDeclaration || indexOf.call(this.context, '?') >= 0)
				);
			}
			...
			addScopeVariables(
				...
				return varBase.eachName((name) => {
					...
					if (this.moduleDeclaration) {
						...
						if (
							name.comments &&
							!o.scope.comments[name.value] &&
							!(this.value instanceof Class) &&
							name.comments.every(function (comment) {
			...
			compileObjectDestruct(o) {
				...
				({ properties: props } = this.variable.base);
			...
			compileConditional(o) {
				...
				if (
					...
					!(left.base instanceof ThisLiteral) &&
			...
			compileSplice(o) {
				...
				answer = [].concat(
					this.makeCode(`${utility('splice', o)}.apply(${name}, [${fromDecl}, ${to}].concat(`),
					valDef,
					this.makeCode(')), '),
					valRef,
				);
			...
			propagateLhs() {
				...
				if (
					!(
						((ref1 = this.variable) != null ? (typeof ref1.isArray === 'function' ? ref1.isArray() : void 0) : void 0) ||
						((ref2 = this.variable) != null ? (typeof ref2.isObject === 'function' ? ref2.isObject() : void 0) : void 0)
					)
				) {
					return;
				}
			...
			throwUnassignableConditionalError(name) {
				return this.variable.error(
					`the variable \"${name}\" can't be assigned with ${this.context} because it has not been declared before`,
				);
			}
	...
	exports.Code = Code = function () {
		class Code extends Base {
			...
			compileNode(o) {
				...
				this.eachParamName(function (name, node, param, obj) {
					...
					if (node.this) {
						...
						target = new IdentifierLiteral(
							o.scope.freeVariable(name, {
								reserve: false,
							}),
						);
						...
						replacement =
							param.name instanceof Obj && obj instanceof Assign && obj.operatorToken.value === '='
								? new Assign(new IdentifierLiteral(name), target, 'object')
								: target; //, operatorToken: new Literal ':'
					...
					if (param.splat || param instanceof Expansion) {
						...
						if (param.shouldCache() || haveBodyParam) {
							...
							if (param.value != null) {
								...
								exprs.push(
									new Assign(new Value(param.name), param.asReference(o), null, {
										param: 'alwaysDeclare',
									}),
								);
							}
				...
				answer = this.joinFragmentArrays(
					function () {
						var len4, p, results1;
						results1 = [];
			...
			disallowSuperInParamDefaults({ forAst } = {}) {
				...
				return this.eachSuperCall(
					Block.wrap(this.params),
					function (superCall) {
	...
	exports.Splat = Splat = function () {
		class Splat extends Base {
			constructor(name, { lhs: lhs1, postfix: postfix = true } = {}) {
				super();
				this.lhs = lhs1;
	...
	exports.While = While = function () {
		class While extends Base {
			constructor(condition1, { invert: inverted, guard, isLoop } = {}) {
				super();
			...
			compileNode(o) {
				...
				answer = [].concat(
					...
					this.processedCondition().compileToFragments(o, LEVEL_PAREN),
					this.makeCode(') {'),
					body,
					this.makeCode('}'),
				);
			...
			processedCondition() {
				return this.processedConditionCache != null
					? this.processedConditionCache
					: (this.processedConditionCache = this.inverted ? this.condition.invert() : this.condition);
			}
	...
	exports.Op = Op = function () {
		...
		class Op extends Base {
			constructor(op, first, second, flip, { invertOperator, originalOperator: originalOperator = op } = {}) {
				...
				if (op === 'new') {
					if (
						((firstCall = unwrapped = first.unwrap()) instanceof Call || (firstCall = unwrapped.base) instanceof Call) &&
						!firstCall.do &&
						!firstCall.isNew
					) {
					...
					if (
						!(
							first instanceof Parens ||
							first.unwrap() instanceof IdentifierLiteral ||
							(typeof first.hasProperties === 'function' ? first.hasProperties() : void 0)
						)
					) {
			...
			invert() {
				...
				if (this.isChain()) {
					...
					((ref1 = fst.operator) === '!' || ref1 === 'in' || ref1 === 'instanceof')
				) {
					return fst;
				} else {
					return new Op('!', this);
	...
	exports.Try = Try = function () {
		class Try extends Base {
			...
			compileNode(o) {
				...
				catchPart = this.catch
					? this.catch.compileToFragments(
							merge(o, {
								indent: originalIndent,
							}),
							LEVEL_TOP,
						)
					: !(this.ensure || this.catch)
			...
			astProperties(o) {
				...
				return {
					...
					finalizer:
						this.ensure != null
							? Object.assign(
									this.ensure.ast(o, LEVEL_TOP),
									mergeAstLocationData(jisonLocationDataToAstLocationData(this.finallyTag.locationData), this.ensure.astLocationData()),
								)
							: null,
				};
			}
		...
		class Existence extends Base {
			...
			compileNode(o) {
				...
				if (this.expression.unwrap() instanceof IdentifierLiteral && !o.scope.check(code)) {
					[cmp, cnj] = this.negated ? ['===', '||'] : ['!==', '&&'];
					code =
						`typeof ${code} ${cmp} \"undefined\"` +
						(this.comparisonTarget !== 'undefined' ? ` ${cnj} ${code} ${cmp} ${this.comparisonTarget}` : '');
				} else {
	...
	exports.Parens = Parens = function () {
		class Parens extends Base {
			...
			compileNode(o) {
				...
				shouldWrapComment =
					(ref1 = expr.comments) != null
						? ref1.some(function (comment) {
				...
				bare =
					o.level < LEVEL_OP &&
					!shouldWrapComment &&
					((expr instanceof Op && !expr.isInOperator()) || expr.unwrap() instanceof Call || (expr instanceof For && expr.returns)) &&
		...
		class StringWithInterpolations extends Base {
			...
			extractElements(o, { includeInterpolationWrappers, isJsx } = {}) {
				...
				expr.traverseChildren(false, (node) => {
					...
					if (node instanceof StringLiteral) {
						...
						if (
							(unwrapped = (ref1 = node.expression) != null ? ref1.unwrapAll() : void 0) instanceof PassthroughLiteral &&
							unwrapped.generated &&
							!(isJsx && o.compiling)
						) {
							if (o.compiling) {
								...
								if (node.comments) {
									(commentPlaceholder.comments != null ? commentPlaceholder.comments : (commentPlaceholder.comments = [])).push(
										...node.comments,
									);
								}
							...
							if (node.comments) {
								((ref2 = node.expression) != null ? (ref2.comments != null ? ref2.comments : (ref2.comments = [])) : void 0).push(
									...node.comments,
								);
							}
			...
			compileNode(o) {
				...
				for (j = 0, len1 = elements.length; j < len1; j++) {
					...
					if (element instanceof StringLiteral) {
						...
						if (
							!this.isNestedTag(element) ||
							code.some(function (fragment) {
								var ref2;
								return (ref2 = fragment.comments) != null
									? ref2.some(function (comment) {
			...
			astProperties(o) {
				...
				for (index = j = 0, len1 = elements.length; j < len1; index = ++j) {
					...
					if (element instanceof StringLiteral) {
						quasis.push(
							new TemplateElement(element.originalValue, {
								tail: element === last,
							})
								.withLocationDataFrom(element)
								.ast(o),
						); // Interpolation
					} else {
						({ expression } = element);
	...
	exports.For = For = function () {
		class For extends While {
			...
			addSource(source) {
				...
				if (
					((ref2 = this.index) != null ? (typeof ref2.isArray === 'function' ? ref2.isArray() : void 0) : void 0) ||
					((ref3 = this.index) != null ? (typeof ref3.isObject === 'function' ? ref3.isObject() : void 0) : void 0)
				) {
			...
			compileNode(o) {
				...
				idt1 = this.tab + TAB;
				if (this.range) {
					forPartFragments = source.compileToFragments(
						merge(o, {
							index: ivar,
							name,
							step: this.step,
				...
				bodyFragments = body.compileToFragments(
					merge(o, {
						indent: idt1,
					}),
					LEVEL_TOP,
				...
				fragments = fragments.concat(
					...
					this.makeCode(forCode),
					forPartFragments,
					this.makeCode(`${forClose} {${guardPart}${varPart}`),
					bodyFragments,
					this.makeCode(this.tab),
					this.makeCode('}'),
				);
				...
				for (caseIndex = j = 0, len1 = ref1.length; j < len1; caseIndex = ++j) {
					...
					for (testIndex = k = 0, len2 = tests.length; k < len2; testIndex = ++k) {
						...
						if (testConsequent != null ? testConsequent.expressions.length : void 0) {
							caseLocationData = mergeLocationData(
								caseLocationData,
								testConsequent.expressions[testConsequent.expressions.length - 1].locationData,
							);
						}
						if (testIndex === 0) {
						...
						cases.push(
							new SwitchCase(test, testConsequent, {
		...
		class If extends Base {
			...
			isStatement(o) {
				...
				return (
					...
					((ref1 = this.elseBodyNode()) != null ? ref1.isStatement(o) : void 0)
				);
			}
			...
			compileStatement(o) {
				...
				if (this.isChain) {
					...
					answer = answer.concat(
						this.makeCode('{\n'),
						this.elseBody.compileToFragments(merge(o, { indent }), LEVEL_TOP),
						this.makeCode(`\n${this.tab}}`),
					);
				}
				return answer;
			...
			processedCondition() {
				return this.processedConditionCache != null
					? this.processedConditionCache
					: (this.processedConditionCache = this.type === 'unless' ? this.condition.invert() : this.condition);
			}
			...
			astProperties(o) {
				...
				return {
					...
					alternate: this.isChain
						? this.elseBody.unwrap().ast(o, isStatement ? LEVEL_TOP : LEVEL_COND)
						: !isStatement && ((ref1 = this.elseBody) != null ? ((ref2 = ref1.expressions) != null ? ref2.length : void 0) : void 0) === 1
							? this.elseBody.expressions[0].ast(o, LEVEL_TOP)
							: (ref3 = (ref4 = this.elseBody) != null ? ref4.ast(o, LEVEL_TOP) : void 0) != null
								? ref3
								: null,
					postfix: !!this.postfix,
	...
	makeDelimitedLiteral = function (
		...
		regex = RegExp(
			`(\\\\\\\\)|(\\\\0(?=\\d))${
				convertTrailingNullEscapes ? /|(\\0)$/.source : '' // Escaped backslash. // Trailing null character that could be mistaken as octal escape.
	...
	sniffDirectives = function (expressions, { notFinalExpression } = {}) {
		...
		while (index <= lastIndex) {
			...
			if (
				(unwrapped = expression != null ? (typeof expression.unwrap === 'function' ? expression.unwrap() : void 0) : void 0) instanceof
					PassthroughLiteral &&
				unwrapped.generated
			) {
				index++;
	...
	exports.mergeLocationData = mergeLocationData = function (locationDataA, locationDataB, { justLeading, justEnding } = {}) {
		return Object.assign(
			...
			{
				range: [
					justEnding ? locationDataA.range[0] : lesser(locationDataA.range[0], locationDataB.range[0]),
					justLeading ? locationDataA.range[1] : greater(locationDataA.range[1], locationDataB.range[1]),
				],
			},
		);
	};
	...
	exports.mergeAstLocationData = mergeAstLocationData = function (nodeA, nodeB, { justLeading, justEnding } = {}) {
		return {
			...
			range: [
				justEnding ? nodeA.range[0] : lesser(nodeA.range[0], nodeB.range[0]),
				justLeading ? nodeA.range[1] : greater(nodeA.range[1], nodeB.range[1]),
			],
	...
	zeroWidthLocationDataFromEndLocation = function ({ range: [, endRange], last_line_exclusive, last_column_exclusive }) {
		return {
	...
	extractSameLineLocationDataFirst = function (numChars) {
		return function ({ range: [startRange], first_line, first_column }) {
			return {
				first_line,
				first_column,
	...
	extractSameLineLocationDataLast = function (numChars) {
		return function ({ range: [, endRange], last_line, last_column, last_line_exclusive, last_column_exclusive }) {
			return {
	...
	emptyExpressionLocationData = function ({ interpolationNode: element, openingBrace, closingBrace }) {
		return {
