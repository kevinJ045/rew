...
module.exports = (context) => {
  ...
  function findLayoutFiles(filePath, root, isClientSide = true, resolveExtensions = [REW_FILE_TYPE.EXTENSION, '.js', '.jsx']) {
    const layouts = [];
    const rootDir = root;
  ...
  function createFileRouter({
    ...
    root = '',
    basePath = '',
    resolveExtensions = [REW_FILE_TYPE.EXTENSION, '.js', '.jsx'],
    bundlerOptions = {},
